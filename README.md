...
> 提交历史完整保留 6 版演进过程，便于对比学习：

```
v2.0              事务 + 批量 Embedding 优化（当前最终版）
5fabe20 (v1.4)    异步向量化 + 全局优化
59d26b3 (v1.3)    PgVector 向量数据库
3bc4271 (v1.2)    Embedding + 文件存储
72bbb0d (v1.1)    TF-IDF + 余弦相似度
40f70d3 (v1.0)    初版：纯 AI 对话
```
